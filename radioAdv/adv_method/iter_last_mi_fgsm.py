'''
Author: your name
Date: 2020-12-21 16:08:44
LastEditTime: 2020-12-21 21:34:42
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /radioAdv/adv_method/iter_last_mi_fgsm.py
'''
import numpy as np
import torch
...
class Iter_Last_MI_FGSM(BaseMethod):
    """[BIM]
    ...
    def __init__(self, model, criterion = None, use_gpu = False, device_id = [0]):
        ...
        Args:
            ...
            criterion ([type]): [损失函数]
        """
        super(Iter_Last_MI_FGSM,self).__init__(model = model, criterion= criterion, use_gpu= use_gpu, device_id= device_id)
