'''
Author: your name
Date: 2020-12-21 16:06:28
LastEditTime: 2020-12-21 16:06:54
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /radioAdv/adv_method/last_ni_fgsm.py
'''
import numpy as np
import torch
...
class Last_NI_FGSM(BaseMethod):
    ...
    def __init__(self, model, criterion = None, use_gpu = False, device_id = [0]):
        ...
        Args:
            ...
            criterion ([type]): [损失函数]
        """
        super(Last_NI_FGSM,self).__init__(model = model, criterion= criterion, use_gpu= use_gpu, device_id= device_id)
